<x-app-layout>
    ...
    <div class="py-8" x-data="{ role: '{{ $partner->partner_role }}', activeMenu: 'identitas' }">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            @if(session('error'))
                <div class="mb-6 p-4 text-sm text-red-800 rounded-xl bg-red-50 border border-red-200 flex items-start gap-3 shadow-sm" role="alert">
                ...
                <div class="lg:w-1/3 space-y-6">
                    <div class="bg-white rounded-[32px] shadow-sm border border-gray-150 p-6 flex flex-col items-center relative overflow-hidden">
                        ...
                        <div class="relative w-24 h-24 mb-4 flex items-center justify-center">
                            ...
                            @endif
                            <div class="w-full h-full rounded-full overflow-hidden border-[3px] border-white shadow-lg flex items-center justify-center relative z-10 {{ $partner->is_vip ? 'bg-gray-900' : 'bg-gray-50' }}">
                                @if($partner->user && $partner->user->avatar)
                                    <img src="{{ Storage::url($partner->user->avatar) }}" class="w-full h-full object-cover">
                                @elseif($partner->is_vip)
