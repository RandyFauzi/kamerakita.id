<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('partners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="mitra_id" class="block text-sm font-medium text-gray-700 mb-1">ID Mitra (Otomatis)</label>
                            <input type="text" name="mitra_id" id="mitra_id" value="{{ old('mitra_id', $nextMitraId) }}" readonly class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm bg-gray-50 text-gray-500 font-semibold focus:outline-none">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="full_name" id="full_name" value="{{ old('full_name') }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" id="nik" value="{{ old('nik') }}" maxlength="16" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="birth_place_date" id="birth_place_date" value="{{ old('birth_place_date') }}" placeholder="Cth: Jakarta, 12-05-1995" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="whatsapp_number" id="whatsapp_number" value="{{ old('whatsapp_number') }}" placeholder="Cth: 08123456789" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="joined_date" id="joined_date" value="{{ old('joined_date', date('Y-m-d')) }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                @error('joined_date') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>
                        </div>

                        <div class="md:col-span-2">
                            <label for="full_address" class="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap Sesuai KTP <span class="text-red-500">*</span></label>
                            <textarea name="full_address" id="full_address" rows="3" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('full_address') }}</textarea>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="smartphone_type" id="smartphone_type" value="{{ old('smartphone_type') }}" placeholder="Cth: iPhone 13 Pro / Samsung S23" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <select name="headstrap_status" id="headstrap_status" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="not_owned" {{ old('headstrap_status') == 'not_owned' ? 'selected' : '' }}>Not Owned</option>
                                <option value="reimburse_process" {{ old('headstrap_status') == 'reimburse_process' ? 'selected' : '' }}>Reimburse Process</option>
                                <option value="reimbursed" {{ old('headstrap_status') == 'reimbursed' ? 'selected' : '' }}>Reimbursed</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="nominal_reimburse" id="nominal_reimburse" value="{{ old('nominal_reimburse', 0) }}" class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                            @error('nominal_reimburse') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label for="headstrap_receipt_path" class="block text-sm font-medium text-gray-700 mb-1">Upload Bukti Nota Headstrap</label>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}" placeholder="Cth: BCA, Mandiri, GoPay" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="account_number" id="account_number" value="{{ old('account_number') }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="account_owner_name" id="account_owner_name" value="{{ old('account_owner_name') }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="base_hourly_rate" id="base_hourly_rate" value="{{ old('base_hourly_rate', 54000) }}" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 border border-transparent rounded-xl font-semibold text-sm text-white hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 shadow-md shadow-indigo-100">
                        Simpan Data Mitra
                    </button>
                </div>
            </form>
