<x-guest-layout>
    <div class="mb-6 text-center">
        <h3 class="text-xl font-bold text-gray-900 leading-tight">Portal Registrasi Mitra</h3>
        <p class="text-xs text-indigo-650 font-bold uppercase tracking-wider mt-1 font-mono">Batch: iPhone 12+</p>
        
        <div class="mt-4 p-3.5 bg-gray-50 border border-gray-150 rounded-2xl text-left text-xs text-gray-500 leading-relaxed">
            Selamat datang di sistem operasional <strong>KameraKita AI</strong>. Halaman ini merupakan jalur registrasi resmi bagi calon mitra freelancer untuk proyek Pengumpulan Data Video Egocentric. Guna memastikan kualitas data untuk pelatihan Computer Vision, kami membutuhkan validasi perangkat sebelum Anda menerima instruksi tugas (SOP).
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('onboarding.submit') }}" class="space-y-4">
        ...
        <!-- Nama Lengkap -->
        <div>
            <label for="full_name" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Nama Lengkap <span class="text-red-500">*</span></label>
        ...
        <!-- Nomor WhatsApp -->
        <div>
            <label for="whatsapp_number" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Nomor WhatsApp Aktif <span class="text-red-500">*</span></label>
            ...
            <p class="text-[10px] text-gray-400 mt-1 font-mono">Untuk verifikasi QC & pembayaran.</p>
            <x-input-error :messages="$errors->get('whatsapp_number')" class="mt-1" />
        </div>

        <!-- Username Fastwork -->
        <div>
            <label for="fastwork_username" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Username Fastwork <span class="text-gray-400">(Opsional)</span></label>
        ...
        <!-- Tipe Perangkat -->
        <div>
            <label for="device_type" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Tipe Perangkat Apple Anda <span class="text-red-500">*</span></label>
        ...
        <!-- Submit Button -->
        <div class="pt-2">
            <button type="submit" class="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-650 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-xs uppercase tracking-widest rounded-xl transition shadow-md shadow-indigo-100 flex items-center justify-center gap-2">
        ...
        <div class="text-[10px] text-gray-400 text-center leading-relaxed pt-2 border-t border-gray-100">
            🔒 Data Anda terenkripsi dan hanya digunakan untuk verifikasi QC & pembayaran. Setelah kirim data, Anda otomatis dialihkan ke WhatsApp Grup resmi tim.
        </div>
    </form>
</x-guest-layout>
