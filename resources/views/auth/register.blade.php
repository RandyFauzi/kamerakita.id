<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <p id="username-hint" class="text-[10px] text-gray-400 mt-1.5 leading-tight">{{ __('auth_view.username_hint') }}</p>
        ...
        <div>
            ...
            <input id="referral_code" type="text" name="referral_code" value="{{ old('referral_code', request('ref')) }}" class="block w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition placeholder-gray-300 font-mono" placeholder="{{ __('auth_view.referral_code_placeholder') }}">
