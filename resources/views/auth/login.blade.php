<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <p class="text-xs text-gray-400 mt-1">Gunakan alamat email mitra Kamerakita.ai Anda.</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="flex items-center">
            ...
            <label for="remember_me" class="ms-2 text-xs font-semibold text-gray-500">{{ __('Ingat perangkat saya') }}</label>
        </div>
