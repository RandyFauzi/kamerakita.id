        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="bg-white rounded-2xl sm:rounded-[32px] p-5 sm:p-8 border border-gray-150 shadow-sm flex flex-col justify-between gap-5 min-h-[180px] sm:min-h-[220px]">
                ...
                <div class="space-y-2 mt-4">
                    ...
                    <a href="{{ route('video-submissions.report-history') }}" class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl text-xs font-bold text-indigo-600 shadow-sm transition-all duration-300">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
