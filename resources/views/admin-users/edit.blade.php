<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin-users.update', $adminUser) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-[32px] border border-gray-150 p-8 space-y-6">
                    <div class="border-b border-gray-100 pb-4">
                        ...
                        <p class="text-xs text-gray-400">Kosongkan password jika tidak ingin mengganti password admin ini.</p>
                    </div>
