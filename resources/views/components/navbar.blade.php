<header class="min-h-16 flex items-start sm:items-center px-4 py-3 sm:px-6 lg:px-8 sticky top-0 z-20 bg-[#f8f8f6]/95 backdrop-blur-md border-b border-gray-200/70">
