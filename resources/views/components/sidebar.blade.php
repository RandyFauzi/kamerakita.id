            ...
            <details class="group border-t border-gray-100 pt-3" open>
                ...
                <div class="mt-1 space-y-1">
                    ...
                    @if(Auth::user()->hasFullAdminAccess())
                        ...
                        <a href="{{ route('onboardings.index') }}" class="flex items-center px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('onboardings.*') ? 'bg-indigo-50/80 text-indigo-750' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                            <svg class="w-5 h-5 mr-3 {{ request()->routeIs('onboardings.*') ? 'text-indigo-600' : 'text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
