...
class McpServerController extends Controller
{
            ...
            if ($method === 'tools/call') {
                ...
                switch ($toolName) {
                    ...
                    case 'batch_reconcile_by_email':
                        ...
                        break;
                    case 'revert_reconcile_by_email':
                        $result = $this->revertReconcileByEmail($args);
                        break;
                    default:
    ...
    private function getAvailableTools()
    {
        return [
            ...
            [
                'name' => 'revert_reconcile_by_email',
                'description' => 'Membatalkan persetujuan batch reconcile untuk email tertentu.',
                'parameters' => [
                    'type' => 'object',
                    'properties' => [
                        'email' => ['type' => 'string'],
    ...
    private function revertReconcileByEmail(array $args)
    {
        try {
